...
test('app renders sidebar account switcher component', async () => {
  ...
  assert.match(component, /account-switcher-sheet/)
  assert.match(component, /openMobileSheet\(/)
  assert.match(component, /closeMobileSheet\(/)
  assert.doesNotMatch(component, /class=\"account-switcher-manage-list\"/)
